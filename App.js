...
export default function App() {
  OneSignal.init("e447346c-f17e-4222-8526-373a052eb25b", {kOSSettingsKeyAutoPrompt: false, kOSSettingsKeyInAppLaunchURL: false}); // Start OneSignal
  ...
  //    <Text style={styles.welcome}>Welcome to React Native! Hi there!</Text>
  ...
  return (
    <WebView
      source={{ uri: 'https://gofile.io/welcome' }}
      style={{ marginTop: 20 }}
    />
  );
}
...
// */
//var appId = 'e447346c-f17e-4222-8526-373a052eb25b';
//
///**
